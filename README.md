...
```
cd code/
python3 eval.py --dataset HAZE4K --pre_trained_model PSNR3425_SSIM9985.pth
python3 eval.py --dataset ITS --pre_trained_model PSNR4131_SSIM9945.pth
python3 eval.py --dataset OTS --pre_trained_model PSNR3659_SSIM9897.pth
```
...
```
cd code/
python3 eval.py --dataset HAZE4K --pre_trained_model PSNR3425_SSIM9985.pth --save_infer_results
